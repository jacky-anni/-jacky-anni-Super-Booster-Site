            ...
            <div className='menu-submenu menu-submenu-classic menu-submenu-left'>
              <ul className='menu-subnav'>
                <li className='menu-item' aria-haspopup='true'>
                  <a href='index.html' className='menu-link'>
                    <span className='svg-icon menu-icon'>
                      {/*begin::Svg Icon | path:/keen/theme/demo1/dist/assets/media/svg/icons/Clothes/Briefcase.svg*/}
                      <svg
                ...
                >
                  <a href='javascript:;' className='menu-link menu-toggle'>
                    <span className='svg-icon menu-icon'>
                      {/*begin::Svg Icon | path:/keen/theme/demo1/dist/assets/media/svg/icons/Code/CMD.svg*/}
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        xmlnsXlink='http://www.w3.org/1999/xlink'
                        width='24px'
                ...
                >
                  ...
                  >
                    <span className='svg-icon menu-icon'>
                      {/*begin::Svg Icon | path:/keen/theme/demo1/dist/assets/media/svg/icons/Communication/Mail-box.svg*/}
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        xmlnsXlink='http://www.w3.org/1999/xlink'
                        width='24px'
                ...
                <li className='menu-item' aria-haspopup='true'>
                  <a href='javascript:;' className='menu-link'>
                    <span className='svg-icon menu-icon'>
                      {/*begin::Svg Icon | path:/keen/theme/demo1/dist/assets/media/svg/icons/Communication/Spam.svg*/}
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        xmlnsXlink='http://www.w3.org/1999/xlink'
                        width='24px'
