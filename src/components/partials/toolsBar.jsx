      ...
      >
        <div className='container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap'>
          ...
          <div className='d-flex align-items-center'>
            ...
            <a
              href='#'
              className='btn btn-light btn-hover-primary btn-sm btn-icon mr-2'
            >
            ...
            <a
              ...
              className='btn btn-light btn-hover-primary btn-sm btn-icon mr-2'
            >
              <i className='flaticon-download-1 text-muted' />
            </a>
            <a
              href='#'
              className='btn btn-light btn-hover-primary btn-sm btn-icon mr-2'
            >
              <i className='flaticon2-fax text-muted' />
            </a>
            <a
              href='#'
              className='btn btn-light btn-hover-primary btn-sm btn-icon mr-2'
            >
              <i className='flaticon2-settings text-muted' />
            </a>
            {/*end::Actions*/}
            {/*begin::Dropdowns*/}
            <div
            ...
            >
              <a
                ...
                aria-expanded='false'
              >
                <i className='ki ki-plus icon-1x' />
              </a>
