...
import { addUser, clear } from "./../../actions/userActions";
...
const CreateUser = ({
  user: { errors, validate, loading, user_ },
  addUser,
  clear
}) => {
      ...
      <div className='card card-custom gutter-b bg-white'>
        {/* <div className='card-header'>
          <div className='card-title'>
            <h3 className='card-label'>Basic Card</h3>
          </div>
        </div> */}
...
CreateUser.propTypes = { profile: PropTypes.object.isRequired };
